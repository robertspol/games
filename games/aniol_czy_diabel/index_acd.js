...
function useFetchedData(data) {
    ...
    function selectingWinner(playerChoice, aiChoice) {
        if (playerChoice && aiChoice) {
            if (playerChoice === 'angel' && aiChoice === 'devil') return 'playerWin';
            else if (playerChoice === 'angel' && aiChoice === 'doubts') return 'compWin';
            else if (playerChoice === 'devil' && aiChoice === 'angel') return 'compWin';
            else if (playerChoice === 'devil' && aiChoice === 'doubts') return 'playerWin';
            else if (playerChoice === 'doubts' && aiChoice === 'angel') return 'playerWin';
            else if (playerChoice === 'doubts' && aiChoice === 'devil') return 'compWin';
    ...
    function start() {
        ...
        computerChoice();
        const result = selectingWinner(selected.playerChoice, selected.aiChoice);
        finalResults(result);
    }
